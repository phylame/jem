...
public final class NumberUtils {
    ...
    public static int parseInt(String str) throws ParserException {
        try {
            ...
            throw new ParserException(Messages.tr("err.number.invalidInteger", str), e);
        }
    }
    ...
    public static double parseDouble(String str) throws ParserException {
        try {
            ...
            throw new ParserException(Messages.tr("err.number.invalidDouble", str), e);
        }
    }
    ...
    public static Number parseNumber(String str) throws ParserException {
        try {
            ...
            throw new ParserException(Messages.tr("err.number.invalidNumber", str), e);
        }
    }
}
