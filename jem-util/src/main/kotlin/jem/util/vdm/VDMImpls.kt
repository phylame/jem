...
class FileVDMFactory : VDMFactory {
    ...
    override fun getReader(input: Any, props: Map<String, Any>): VDMReader =
            FileVDMReader(getDirectory(input, true))

    override fun getWriter(output: Any, props: Map<String, Any>): VDMWriter =
...
private class ZipVDMEntry(
        val entry: ZipEntry, val reader: ZipVDMReader? = null, val writer: ZipVDMWriter? = null
) : VDMEntry {
