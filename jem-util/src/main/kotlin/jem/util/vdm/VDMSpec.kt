...
package jem.util.vdm

import jem.util.ServiceManager
import jem.util.ServiceProvider
...
interface VDMFactory : ServiceProvider {
    fun getReader(input: Any, props: Map<String, Any>): VDMReader

    fun getWriter(output: Any, props: Map<String, Any>): VDMWriter
}

object VDMManager : ServiceManager<VDMFactory>(VDMFactory::class.java) {
    fun openReader(name: String, input: Any, props: Map<String, Any> = emptyMap()): VDMReader? =
            get(name)?.getReader(input, props)

    fun openWriter(name: String, output: Any, props: Map<String, Any> = emptyMap()): VDMWriter? =
