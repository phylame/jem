...
fun printJemError(e: JemException, file: File, format: String) {
    if (e is ParserException) {
        ...
        App.error(tr("error.jem.make", file, format), e)
...
fun openBook(tuple: InTuple): Book? {
    try {
        ...
        printJemError(e, tuple.file, tuple.format)
    }
    return null
}
...
fun prepareArguments(args: MutableMap<String, Any>): MutableMap<String, Any> {
...
fun saveBook(book: Book, tuple: OutTuple): String? {
    ...
    try {
        ...
        printJemError(e, tuple.output, tuple.format)
    }
    return null
}
